...
const MANUAL_SECTIONS = [
  {
    ...
    tab: "시작하기",
    html: `
      <p class="man-p">필명과 <b>비밀번호</b>를 넣고 <b>입장하기</b>를 누르면 끝이에요.
      프사는 필명에 맞는 색의 눈사람으로 자동 배정되고, 사진으로 바꿀 수 있어요.</p>

      <div class="man-warn">
        <b>처음 들어올 때 정한 비밀번호가 그 필명의 자물쇠</b>가 돼요.
        먼저 들어온 사람이 그 필명의 주인이 되고, 그 뒤로는 비밀번호를 아는
        사람만 그 필명으로 들어올 수 있습니다. <b>6자 이상</b>으로 정해주세요.<br>
        비밀번호를 잊으면 스스로 되돌릴 수 없어요. 방장에게 말해야 합니다.
      </div>
      ...
      <div class="man-tip">
        화면은 네 칸이에요. <b>채팅</b> · <b>접속자</b> · <b>뽀모도로</b> · <b>글자수</b>.<br>
        가로 보기는 <b>채팅 | 접속자 | (뽀모 위 · 글자수 아래)</b>,
        세로 보기는 <b>2칸 × 2줄</b>로 놓입니다.<br>
        칸 사이의 회색 손잡이를 <b>끌면 크기가 바뀌고</b>, 더블클릭하면 기본값으로 돌아가요.
        채팅은 <b>›</b> 로 접을 수 있어요.<br>
        <b>자리는 각자 원하는 대로 바꿀 수 있어요.</b> ⚙️ 설정 → 💬 채팅에서요.<br>
        <b>오늘 목표와 나의 투두는 창이 아니에요.</b> 내 카드 아래를 누르면 팝업으로 열립니다.
      </div>
    `
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td>펫</td><td>상태표 아래에 <b>내 펫</b>이 살아요. 레벨과 진행 바가 함께 보이고, 집필 시간이 쌓이면 <b>형태가 바뀌며 자랍니다</b></td></tr>
        <tr><td>업적 배지</td><td>🏆👑 는 <b>닉네임 앞</b>에 붙어요</td></tr>
        ...
        <tr><td><b>상태표를 누르면</b></td><td>상태 고르기 — WORK · 🔥WORK🔥 · 휴식 · 자리비움</td></tr>
        <tr><td>안테나 표시</td><td>아래쪽 상자 <b>왼쪽 위의 작은 안테나</b>. <b>초록</b>이면 접속 중, 인터넷이 끊기면 <b>붉게 깜빡이며 막대가 줄어요</b></td></tr>
        <tr><td><b>내 카드 아래</b></td><td>오늘 목표와 나의 투두가 열려요</td></tr>
  ...
  },
  {
    ...
    html: `
      ...
      <div class="man-tip">
        상태는 <b>WORK · 🔥WORK🔥 · 휴식 · 자리비움</b> 넷이에요.
        <b>카드의 상태표를 눌러</b> 바꿉니다. <b>WORK와 🔥WORK🔥 만 펫의 밥이 됩니다.</b><br>
  ...
  },
  {
    ...
    html: `
      <table class="man-t"><tbody>
        ...
        <tr><td>🏆 연속 출석</td><td>3일 이상 이어서 접속하면 닉네임 앞에 배지가 붙어요. 하루라도 빠지면 처음부터</td></tr>
        <tr><td>👑 풀출석</td><td>지난주에 매일 접속했다면 카드가 금색으로 빛나요</td></tr>
        <tr><td>🐾 펫</td><td>⚙️ 설정 → <b>🐾 펫</b>. <b>WORK</b>와 <b>🔥WORK🔥</b> 시간만 쌓여서 <b>5시간에 1레벨</b>, <b>100시간에 만렙(Lv.20)</b>이에요</td></tr>
        <tr><td>Lv.1 껍데기</td><td>처음엔 <b>알 · 보자기 · 나무 상자 · 씨앗 · 선물 상자</b> 중 하나로 와요. Lv.1 동안은 <b>껍데기를 바꿀 수 있어요.</b> 다만 <b>안에 무엇이 들었는지는 비밀</b>입니다</td></tr>
        ...
        <tr><td>✍️ 글자수</td><td><b>지금 원고의 전체 글자수</b>를 적으면 직전에 적은 값과의 <b>차이만</b> 쌓여요. 매번 얼마나 썼는지 계산할 필요가 없습니다</td></tr>
        <tr><td>▶ 기준 · 🧹 초기화 · 🆕 새 편</td><td>차례로 <b>출발선만 옮기기</b> · <b>오늘 누적을 0으로</b> · <b>빈 문서에서 새로 시작</b> 이에요</td></tr>
        <tr><td>순위가 없는 이유</td><td>오늘 탭은 <b>대화처럼 흐르기만</b> 합니다. 누가 위인지 아래인지는 어디에도 안 나와요. 견주는 건 '내 기록' 탭의 <b>지난 요일의 나</b> 뿐입니다</td></tr>
      </tbody></table>
