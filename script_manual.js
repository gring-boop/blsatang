...
const MANUAL_SECTIONS = [
  {
    ...
    html: `
      ...
      <div class="man-tip">
        화면은 다섯 칸이에요. <b>채팅</b> · <b>접속자 프로필</b> · <b>뽀모도로</b> · <b>오늘 목표/상태</b> · <b>나의 할일</b>.<br>
        칸 사이의 회색 손잡이를 <b>끌면 크기가 바뀌고</b>, 더블클릭하면 기본값으로 돌아가요.
        채팅은 <b>›</b> 로 접을 수 있어요.<br>
        <b>다섯 칸의 자리는 각자 원하는 대로 바꿀 수 있어요.</b> ⚙️ 설정 → 💬 채팅에서요.
      </div>
    `
  },
  {
    ...
    html: `
      ...
      <table class="man-t"><tbody>
        ...
        <tr><td><b>기록 보기</b></td><td>카드 <b>아래쪽 상자를 누르면</b> 그 분의 작업 기록이 열려요. 오늘 상태별 시간과 지난 7일 집필 시간</td></tr>
      </tbody></table>
  ...
  },
  {
    ...
    html: `
      <table class="man-t"><tbody>
        ...
        <tr><td>좁은 화면</td><td>창이 좁아지면 위쪽에 <b>탭 다섯 개</b>가 생겨요. 다른 창을 보는 동안 채팅이 오면 <b>💬 탭에 빨간 숫자</b>가 붙습니다</td></tr>
      </tbody></table>
